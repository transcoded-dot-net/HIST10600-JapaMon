...
def loss():
    ...
    go2()
    go3()
#defining suicide end case
#def suicide():
    # label = Label(text="遂", font =("MS Mincho", 325))
    # label2 = Label(text="(suicide)", font= ("Charmonman", 50))
...
# #printhp = Button(win, text = "print hp", command=prints)
#printhp.pack()
win.mainloop()